 ...
 * $Id$
 */
package org.openhealthtools.mdht.uml.cda.fhim.operations;
...
import org.openhealthtools.mdht.uml.cda.fhim.FHIMPlugin;
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MySection#validateMySectionTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Section Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MySection#validateMySectionCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Section Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MySection#validateMySectionTitle(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Section Title</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MySection#validateMySectionMyActivity(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Section My Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MySectionOperations extends SectionOperations {
	...
	public static  boolean validateMySectionTemplateId(MySection mySection, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_MY_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(FHIMPackage.Literals.MY_SECTION);
			try {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_MY_SECTION_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(mySection)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_SECTION__MY_SECTION_TEMPLATE_ID,
						 FHIMPlugin.INSTANCE.getString("MySectionTemplateId"),
...
"value.code = '48764-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_SECTION__MY_SECTION_CODE,
						 FHIMPlugin.INSTANCE.getString("MySectionCode"),
						 new Object [] { mySection }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_SECTION__MY_SECTION_TITLE,
						 FHIMPlugin.INSTANCE.getString("MySectionTitle"),
						 new Object [] { mySection }));
			}
			return false;
		}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MY_SECTION_MY_ACTIVITY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.entry->exists(entry : cda::Entry | entry.act.oclIsKindOf(fhim::MyActivity) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)";
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * self.entry->exists(entry : cda::Entry | entry.act.oclIsKindOf(fhim::MyActivity) and entry.typeCode = vocab::x_ActRelationshipEntry::COMP)
	 * @param mySection The receiving '<em><b>My Section</b></em>' model object.
	 * @param diagnostics The chain of diagnostics to which problems are to be appended.
	 * @param context The cache of context-specific information.
	 * <!-- end-model-doc -->
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_SECTION__MY_SECTION_MY_ACTIVITY,
						 FHIMPlugin.INSTANCE.getString("MySectionMyActivity"),
						 new Object [] { mySection }));
			}
			return false;
		}
