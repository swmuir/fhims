 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyDocument#validateMyDocumentTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Document Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyDocument#validateMyDocumentMySection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Document My Section</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MyDocumentOperations extends ContinuityOfCareDocumentOperations {
	...
	public static  boolean validateMyDocumentTemplateId(MyDocument myDocument, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_MY_DOCUMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(FHIMPackage.Literals.MY_DOCUMENT);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 FHIMValidator.MY_DOCUMENT__MY_DOCUMENT_TEMPLATE_ID,
						 FHIMPlugin.INSTANCE.getString("MyDocumentTemplateId"),
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_MY_DOCUMENT_MY_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.getSections()->one(section : cda::Section | section.oclIsKindOf(fhim::MySection))";
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_DOCUMENT__MY_DOCUMENT_MY_SECTION,
						 FHIMPlugin.INSTANCE.getString("MyDocumentMySection"),
						 new Object [] { myDocument }));
			}
			return false;
		}
