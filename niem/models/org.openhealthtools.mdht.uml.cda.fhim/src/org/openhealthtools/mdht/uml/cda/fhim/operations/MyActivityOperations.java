 ...
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyActivity#validateMyActivityTemplateId(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Activity Template Id</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyActivity#validateMyActivityClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Activity Class Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyActivity#validateMyActivityMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Activity Mood Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyActivity#validateMyActivityCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Activity Code</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.uml.cda.fhim.MyActivity#validateMyActivityStatusCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate My Activity Status Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MyActivityOperations extends ProblemActOperations {
	...
	public static  boolean validateMyActivityTemplateId(MyActivity myActivity, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (VALIDATE_MY_ACTIVITY_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			...
			helper.setContext(FHIMPackage.Literals.MY_ACTIVITY);
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 FHIMValidator.MY_ACTIVITY__MY_ACTIVITY_TEMPLATE_ID,
						 FHIMPlugin.INSTANCE.getString("MyActivityTemplateId"),
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_ACTIVITY__MY_ACTIVITY_CLASS_CODE,
						 FHIMPlugin.INSTANCE.getString("MyActivityClassCode"),
						 new Object [] { myActivity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_ACTIVITY__MY_ACTIVITY_MOOD_CODE,
						 FHIMPlugin.INSTANCE.getString("MyActivityMoodCode"),
						 new Object [] { myActivity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_ACTIVITY__MY_ACTIVITY_CODE,
						 FHIMPlugin.INSTANCE.getString("MyActivityCode"),
						 new Object [] { myActivity }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 FHIMValidator.DIAGNOSTIC_SOURCE,
						 FHIMValidator.MY_ACTIVITY__MY_ACTIVITY_STATUS_CODE,
						 FHIMPlugin.INSTANCE.getString("MyActivityStatusCode"),
						 new Object [] { myActivity }));
			}
			return false;
		}
