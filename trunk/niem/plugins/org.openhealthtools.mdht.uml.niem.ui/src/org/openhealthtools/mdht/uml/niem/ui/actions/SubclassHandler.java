	...
	private void populateSubclassWithSelection(Object[] selectionArray, Class selectedClass) {
		...
		if (selectionArray != null) {
			...
			for (Property property : cleanList) {
				...
				// Inject logic to put term valueset on "code" properties
				
				if ("Code".equals(clonedProperty.getType().getName())) {
					TermProfileUtil.applyStereotype(clonedProperty,
							ITermProfileConstants.VALUE_SET_CONSTRAINT);
				}
